...
const OxygenConcentrator = () => {
  ...
  const brochures = [
    { name: 'Oxygen Concentrator', file: '/brochures/everflo-home-oxygen-system.pdf' },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h2 className=" font-sans-bold text-center text-4xl text-gray-400 mb-5">Oxygen Concentrator</h2>
